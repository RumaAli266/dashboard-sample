...
interface BreadcrumbsProps {
  ...
  rightAlign?: boolean;
  separator?: React.ComponentType | React.ReactElement;
  title?: boolean;
  titleBottom?: boolean;
}
...
const Breadcrumbs:React.FC<any> = ({
  ...
  // Check if SeparatorIcon is a valid React component
  const separatorIcon = SeparatorIcon && typeof SeparatorIcon === 'function' ? (
    <SeparatorIcon />
  ) : (
